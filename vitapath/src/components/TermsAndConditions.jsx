...
const PrivacyPolicy = () => {
    return (
    <div className="terms-and-conditions" style={{ padding: '40px' }}>
          ...
          >
            ...
            >
              ...
              >
                ...
                at <bdt className="question">Retorno Lima Antigua 11020-D</bdt>
                <bdt className="block-component" />,{" "}
                <bdt className="question">Lomas Virreyes</bdt>
                <span
                  style={{
                    fontSize: "11.0pt",
                    lineHeight: "115%",
                ...
                , <bdt className="question">Tijuana</bdt>
              </span>
            </span>
                ...
                <span style={{ fontSize: 15 }}>
                  <span data-custom-class="body_text">
                    <span style={{ color: "rgb(89, 89, 89)" }}>
                      <bdt className="block-component" />,{" "}
                      <bdt className="question">Baja California</bdt>
                      <bdt className="statement-end-if-in-editor" />
                      <bdt className="block-component" />{" "}
                      <bdt className="question">22240</bdt>
                      <bdt className="statement-end-if-in-editor" />
                    </span>
                  </span>
                </span>
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          the website <a data-custom-class="link" href="https://vita-path.com/">https://vita-path.com/</a>
      ...
      >
        ...
        >
          ...
          phone at <bdt className="question">526631041142</bdt>, email at{" "}
          <bdt className="question">ivanlorenzana@outlook.com</bdt>
          <bdt className="block-component" />,
          <bdt className="statement-end-if-in-editor" /> or by mail to{" "}
          <bdt className="question">Retorno Lima Antigua 11020-D</bdt>
          <bdt className="block-component" />,{" "}
          <bdt className="question">Lomas Virreyes</bdt>
          <bdt className="statement-end-if-in-editor" />,{" "}
          <bdt className="question">Tijuana</bdt>
      ...
      >
        ...
        >
          ...
          <bdt className="statement-end-if-in-editor" />
          ), and <bdt className="question">Vitapath Inc</bdt>, concerning your
      ...
      >
        ...
        >
          ...
          <bdt className="question">ivanlorenzana@outlook.com</bdt>, as stated
      ...
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <a data-custom-class="link" href="#mobile">
          <span style={{ color: "rgb(0, 58, 250)", fontSize: 15 }}>
            <span data-custom-class="body_text">
              <bdt className="block-component" />
              10. MOBILE APPLICATION <bdt className="block-component" />
              LICENSE
              <bdt className="statement-end-if-in-editor" />
              <bdt className="statement-end-if-in-editor" />
            </span>
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          <bdt className="question">ivanlorenzana@outlook.com</bdt>. If we ever
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      <div
        ...
        style={{ lineHeight: "1.5" }}
      >
        <span style={{ fontSize: 15 }}>All purchases are non-refundable.</span>
      </div>
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <span style={{ fontSize: 15 }}>
          <br />
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        <strong>
          <span style={{ fontSize: 19 }}>6. SOFTWARE</span>
        </strong>
      </div>
      <div className="MsoNormal" style={{ lineHeight: "1.5" }}>
        <br />
    ...
    <div align="center" style={{ textAlign: "left" }}>
      ...
      >
        ...
        >
          ...
          for any revenue-generating <bdt className="block-component" />
          endeavor
          <bdt className="statement-end-if-in-editor" />, commercial enterprise,
          or other purpose for which it is not designed or intended; (6) make
          the App available over a network or other environment permitting
      ...
      >
        ...
        >
          ...
          license
          <bdt className="statement-end-if-in-editor" /> granted to you for our
          App is limited to a non-transferable{" "}
          <bdt className="block-component" />
          license
          <bdt className="statement-end-if-in-editor" /> to use the application
          on a device that <bdt className="block-component" />
          utilizes
        ...
        <strong>
          ...
          <span style={{ color: "rgb(0, 58, 250)" }}>
            <bdt
              ...
              data-type="question"
            >
              <a data-custom-class="link" href="https://vita-path.com/">
                https://vita-path.com/
                </a>
            </bdt>
          </span>
    ...
    >
      ...
      >
        ...
        . <bdt className="question">Vitapath Inc</bdt> and yourself irrevocably
    ...
    >
      ...
      <bdt className="question">three (3)</bdt>. The seat, or legal place, or
      ...
      <bdt className="question">Spanish</bdt>. The governing law of these Legal
      Terms shall be substantive law of <bdt className="block-component" />
      <bdt className="block-component" />
      <bdt className="question">Mexico</bdt>
      <bdt className="statement-end-if-in-editor">
        <bdt className="statement-end-if-in-editor" />
    ...
    >
      ...
      >
        ...
        <bdt className="block-component" />
        defense
        <bdt className="statement-end-if-in-editor" /> and control of any matter
        for which you are required to indemnify us, and you agree to cooperate,
        at your expense, with our <bdt className="block-component" />
        defense
    ...
    >
      <strong>
        ...
        >
          <strong>
            <bdt className="block-component" />
            Phone: <bdt className="question">526631041142</bdt>
            <bdt className="statement-end-if-in-editor" />
          </strong>
        </span>
        &nbsp;
